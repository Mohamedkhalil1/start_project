...
trait GeneralTrait{
    ...
    protected function showAll($key,Collection $collection,$paginate = 0,$code=200){
       ...
       if($paginate === 1){
        ...
        $collection = $this->transformData($collection,$transformer);
        $collection = $this->cacheResponse($collection);
        return $this->successResponse($key,$collection['data'], $code);
       }
    ...
    protected function showOne($key,Model $instance , $code=200){
       ...
       return $this->successResponse($key,$instance['data'],$code);
    } 
    ...
    private function cacheResponse($data){
     ...
     {
         return $this->errorResponse($code, $validator->errors()->first(),404);
     }
